 ...
 * @author Sanjay
 */
public class AllCurrentStudents extends javax.swing.JFrame {

    /**
     * Creates new form AllCurrentStudents
     */
    public AllCurrentStudents() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile", "Father Name", "Mother Name", "E-Mail", "Address", "College", "Aadhaar", "Room"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 54, 670, -1));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 36, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllCurrentStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

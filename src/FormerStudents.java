 ...
 * @author Sanjay
 */
public class FormerStudents extends javax.swing.JFrame {

    /**
     * Creates new form FormerStudents
     */
    public FormerStudents() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 67, 670, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormerStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
